...
import static api.afrilangue.serrvices.assessment.AssessmentUtils.checkAnswer;
...
public class CheckBasicAssessment implements AssessmentFactory {
    ...
    public ResponseAssessment checkAssessment(RequestAssessment requestAssessment) {
        ...
        boolean check = answers
                .stream()
                .anyMatch(answer -> checkAnswer(requestAssessment.getAnswerLetter(), answer.getContent()));
